...
Статус на 2026-09-23: подтверждено двумя независимыми воспроизведениями; исправление закоммичено в версии 0.8.0-dev.3. Перед применением в проекте проверь версию установленного пакета.
