...
Это development-версия. Managed-выполнение 1С runtime пока заблокировано до проверки и разрешения точного адаптера и тестовой базы. Source-only проверка не доказывает готовность полного 1С SDLC.
