...
function Test-BFCodexCapability {
    ...
    if ($version.exit_code -ne 0 -or $versionText -ne 'codex-cli 0.153.0') { throw "BF_BLOCKED: unverified Codex host version: $versionText. Run and review the host capability suite before supporting it." }
